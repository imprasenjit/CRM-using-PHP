        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">My Dashboard (SID : <?=$this->session->__ci_last_regenerate?>)</li>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-primary o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?=$this->ticketsnew_model->tot_rows()?> NEW!</div>
                            </div>
                            <a href="<?=base_url('ticketsnew')?>" class="card-footer text-white clearfix small z-1">
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-warning o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?=$this->ticketsopen_model->tot_rows()?> OPEN!</div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-success o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?=$this->ticketsclose_model->tot_rows()?> RESOLVED!</div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-danger o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?=$this->tickets_model->tot_rows()?> TOTAL</div>
                            </div>
                ...
                <div class="row">
                        ...
                        <div class="card tblcard border-secondary">
                            ...
                            <div class="card-body card-body-padding" style="padding: 1px">
                                <table class="table table-bordered dtbl">
                                    ...
                                    <tbody>
                                        <?php
                                        if($this->supports_model->get_lastrows()) {
                                            foreach ($this->supports_model->get_lastrows() as $rows) {
                    ...
                    <div class="col-md-6" style="padding-left:5px; padding-right: 10px;">
                        <div class="card tblcard border-secondary">
                            <div class="card-header">
                                <i class="fa fa-phone"></i> Last calls records
                            ...
                            <div class="card-body card-body-padding" style="padding: 1px">
                                <table class="table table-bordered dtbl">
                                    ...
                                    <tbody>
                                        <?php
                                        if($this->calls_model->get_lastrows()) {
                                            foreach ($this->calls_model->get_lastrows() as $cls) {
                                                $call_id = $cls->call_id;
                                                $cno = $cls->cno;
                                                $cname  = $cls->cname;
                                                $status = getstatus($cls->call_status);
                                                ?>
                                                <tr>
                                                    <td><?=sprintf("%05d", $call_id)?></td>
                                                    <td>
                                                        <a id="<?=$call_id?>" data-toggle="modal" data-target="#callviewModal" href="javascript:void(0)">
                                                            <?=word_limiter($cname, 2)?>
                                                        </a>                                                        
                                                    </td>
                                                    <td>+91 <?=$cno?></td>
