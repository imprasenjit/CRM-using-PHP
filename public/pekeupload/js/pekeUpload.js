...
(function ($) {
    $.fn.pekeUpload = function (options) {
        ...
        var defaults = {
            ...
            delfiletext: "<i class='fa fa-remove'></i> Remove",
            ...
            replacehtml: function () {
                ...
                switch (options.dragMode) {
                    ...
                    case false:
                        switch (options.bootstrap) {
                            case true:
                                html = '<a href="javascript:void(0)" class="btn btn-primary btn-upload pkuparea"> <i class="fa fa-upload"></i> ' + options.btnText + "</a>";
                                break;
            ...
            addRow: function (file) {
                ...
                switch (options.bootstrap) {
                    case true:
                        ...
                        var finfo = $('<div class="col-md-10" style="text-align:right; padding-right:0px"></div>').appendTo(newRow);
                        if (options.showFilename) {

                            finfo.append('<div class="col-md-12 filename">' + file.name + "</div>");
                            var progress = $('<div class="col-md-12 progress" style="padding-right:0px; padding-left:0px"><div class="pkuppbr progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="min-width: 2em; height:1.5rem; line-height:25px; font-size:12px"></div></div>').appendTo(finfo);
                        ...
                        var dismiss = $('<div class="col-md-2" style="text-align:left; padding-left:0px; margin-top:20px"></div>').appendTo(newRow);
                        $('<a href="javascript:void(0);" class="btn btn-danger pkdel" style="padding:1px 4px; font-size:14px; line-height:1.5">' + options.delfiletext + '</a>').appendTo(dismiss);
                        break;
                    ...
                    case false:
                        ...
                        if (options.notAjax == false) {
                            var progress = $('<div class="progress-pekeupload"><div class="pkuppbr bar-pekeupload pekeup-progress-bar"><span></span></div></div>').appendTo(finfo);
                            if (options.showPercent) {
                ...
                switch (type) {
                    ...
                    default:
                        if (options.bootstrap) {
                            var prev = $('<i class="fa fa-image-o"></i>').appendTo(container);
                        } else {
